...
<body>
	...
	<div class="d-flex justify-content-end my-page-up ">
		<img onclick="window.scrollTo(0,0)"
			src="${pageContext.request.contextPath }/resources/images/upBtn.png">
	</div>


	<div class="top-box mb-5">
		<img
			src="${pageContext.request.contextPath }/displayImage?fileName=${keyReview.reviewPath}">
	</div>
		...
		<div class="content-box">
			...
			<div class="d-block">
				...
				<div>
					...
					<!-- 팔로우 기능은 일단 보류 -->
					<div
						class="d-flex justify-content-between align-items-center mb-5 mt-3 my-info">
						<h4>
							<img class="my-profile-img"
								src="${pageContext.request.contextPath }/resources/images/profileImg.jpg">${keyReview.memName}</h4>
						<button type="button" class="btn btn-info">팔로우</button>
					</div>
				</div>
				...
				<div>
					...
					<div class="mt-5 mb-5">
						<form id="replyForm" class="row"
							...
							<input type="hidden" name="memId"
								value="${sessionScope.login.memId }"> <input
								type="hidden" name="reviewNo" value="${keyReview.reviewNo }">
							<div class="col-10">
					...
					<div id="replyBox" class="reply-box mb-5">
						...
						<c:forEach items="${keyReplyList }" var="replyDTO">
							...
							<!-- 대댓글 기능 (추후) -->
							<form class="d-none" id="replyForm" class="row"
								action="${pageContext.request.contextPath }/replyWriteDo"
								method="POST">
								<div class="col-1"></div>
								<img class="my-profile-img col-1" style="padding: 0;"
									src="${pageContext.request.contextPath }/resources/images/profileImg.jpg">
								<input type="hidden" name="memId"
									value="${sessionScope.login.memId }"> <input
									type="hidden" name="reviewNo" value="${keyReview.reviewNo }">
								...
								<button id="replyBtn" class="btn btn-primary col-1"
									style="padding: 0px" type="button">등록</button>
							</form>
